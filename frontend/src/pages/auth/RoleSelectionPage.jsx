  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#F7F5F2', display: 'flex', flexDirection: 'column' }}>
      ...
      >
        ...
        >
          <h1 style={{ fontSize: '2rem', fontWeight: 800, color: 'white', margin: '0 0 6px' }}>
            Welcome to OrderUp
          </h1>
        ...
        >
          <h2 style={{ fontSize: '1rem', fontWeight: 700, color: '#1a1a2e', margin: '0 0 1rem' }}>
            Select Your Role
          </h2>
            ...
            {roles.map((role) => {
              ...
              return (
                <article
                  ...
                  style={{
                    ...
                    boxShadow: isSelected
                      ? '0 4px 16px rgba(192,71,74,0.12)'
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', marginBottom: '0.6rem' }}>
                    <div
                      style={{
                        ...
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        flexShrink: 0,
                        boxShadow: isSelected ? '0 4px 10px rgba(192,71,74,0.3)' : 'none',
                        transition: 'all 0.2s ease',
                      }}
                    >
                      {role.icon}
                  ...
                  {/* Description */}
                  <p style={{ fontSize: '0.85rem', color: '#777', margin: '0 0 0.8rem', lineHeight: 1.6 }}>
                    {role.description}
                  </p>
                  ...
                  {/* Name input - only shows when selected */}
                  {isSelected && (
                    <div
                    ...
                    >
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setNameInputs((prev) => ({ ...prev, [role.id]: e.target.value }))
                        }
                        style={{
                          width: '100%',
                          padding: '10px 14px',
          ...
          <button
            ...
            style={{
              ...
              background: canContinue
                ? 'linear-gradient(135deg, #C0474A 0%, #E8726A 100%)'
                : '#E0E0E0',
